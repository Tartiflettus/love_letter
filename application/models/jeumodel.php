...
class JeuModel extends CI_Model {
    ...
    function action($arg1) {
        ...
        if ($actu != $_SESSION["num_joueur"]) {
            ...
            //passer au joueur suivant si �limin�
            if ($this->estElimine()) {
                echo 'Elimin�';
                $this->setEtat("pioche");
        ...
        switch ($etat) {
            case "pioche":
                //enl�ve la protection en d�but de tour 
        ...
        //arr�te le jeu si pioche vide � la fin du tour
    ...
    function application_regles($id_carte_choisie) {
        ...
        //ne pas appliquer r�gles si joueur choisi est prot�g�
